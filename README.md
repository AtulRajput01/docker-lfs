# Mark Waite's Jenkins LTS JDK 11 Docker image with plugins and jobs
...
docker run -i --rm -p 8080:8080 -p 50000:50000 --restart always -v ~/.m2/:/var/jenkins_home/.m2/ -v ~/public_html/:/var/jenkins_home/userContent/ -t markewaite/lts-with-plugins:latest
```
